...
cryptsetup luksOpen /dev/disk/by-uuid/13571e34-f219-43b5-9dc2-bb3ad519e5a0  backup || cryptsetup luksOpen /dev/disk/by-uuid/88710eaa-55b0-4070-bd26-c182d2d075f3  backup
mount -o user_xattr /dev/backup-01/backup-01 /mnt/backup
ionice -c 3 rsync --delete --inplace --no-whole-file -aAvx /      /mnt/backup/mountpoints/slash --exclude=".snapshot/" --exclude=/var/spool/squid3/ --exclude=srv/backups/timemachine/
